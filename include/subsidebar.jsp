							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-file-image-o"></i> Banner <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
                                                                            <li><a href="subAddBanner.jsp">Add Banner</a>
										</li>
										<li><a href="subview_Banner.jsp">View Banner</a>
										</li>
									</ul>
								</li>
                                                                <li><a><i class="fa fa-file-image-o"></i> Gallery <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
                                                                            <li><a href="subAddGallery.jsp">Add Gallery</a>
										</li>
										<li><a href="subview_Gallery.jsp">View Gallery</a>
										</li>
									</ul>
								</li>
									...
									<ul class="nav child_menu" style="display: none">
										...
										<li><a href="subview_Category.jsp">View Category</a>
										</li>
                                                                                
                                                                                <li><a href="subview_SubCategory.jsp">View Sub-Category</a>
										</li>
                                                                                <li><a href="subAddItem.jsp">Add Item</a>
										</li>
                                                                                <li><a href="subview_Item.jsp">View Item</a>
										</li>
									</ul>
								</li>
								<li><a><i class="glyphicon glyphicon-heart-empty"></i> Testimonial <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
                                                                            <li><a href="subTestimonial.jsp">View Testimonial</a>
										</li>
									...
									<ul class="nav child_menu" style="display: none">
                                                                            <li><a href="subADD_FAQ.jsp">Add FAQ</a>
										</li>
										 <li><a href="subView_FAQ.jsp">View FAQ</a>
										</li>
									</ul>
								</li>
									...
									<ul class="nav child_menu" style="display: none">
                                                                           ...
                                                                           <li><a href="subview_Team.jsp">View Team</a>
						                           </li>
									...
									<ul class="nav child_menu" style="display: none">
										 ...
										 <li><a href="service_Query.jsp">Service Query</a>
                                                                 ...
                                                                 <li><a><i class="fa fa-home"></i>Pin<span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
                                                                            <li><a href="subAddPin.jsp">Add Pin</a>
										</li>
										
                                                                            <li><a href="subview_Pin.jsp">View Pin</a>
										</li>
