        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
                    ...
                    if(filepart.getSize()>0)
             {
                ...
                PreparedStatement ps=conn.prepareStatement("update admin set adminName=?,email=?,image=?,website=?,address=?,mobile=? where adminId=?");
                ps.setString(1, name);
                 ...
                 else
               {
                ...
                out.println("</script>");
                    ...
                    {
                        PreparedStatement ps1=conn.prepareStatement("update admin set adminName=?,email=?,website=?,address=?,mobile=? where adminId=?");
