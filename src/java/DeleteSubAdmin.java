    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try
            {
                ...
                PreparedStatement ps=conn.prepareStatement("Delete from SubAdmin where subAdminId=?");
                ps.setString(1, id);
                ...
                if(file.delete())
                {
                    out.println("<script type=\"text/javascript\">");
                        out.println("alert('SubAdmin Deleted')");
                ...
                {
                    out.println("<script type=\"text/javascript\">");
                        out.println("alert('Problem in Deleting SubAdmin')");
                        out.println("window.location.href='admin/view_subadmin.jsp'");
                        out.println("</script>");
