...
String status=request.getParameter("status");
                  ...
                  <form action ="../EditItem1" method="post" name="my_form" class="form-horizontal form-label-left" onSubmit="document.my_form.editor_contents.value = $('#editor').html()" enctype="Multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" value="<%=name%>" pattern="([A-Za-z .])+" name="title" title="Enter Words Only" required="required" placeholder="Enter Title here" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="price" pattern="[0-9]{1,8}" value="<%=price%>" name="price" title="Enter Digits Only and it should not be more then INR 9.99 Crore" required="required" placeholder="Enter Price in &#8377" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="stock" id="stock" pattern="[0-9]{1,20}" name="stock" value="<%=stock%> "title="Enter Digits Only" required="required" placeholder="Enter Stock Limit" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                        <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="discount" pattern="[0-9]{1,2}" value="<%=discount%>" name="discount" title="Enter Digits Only and shoul not be more then 99" required="required" placeholder="Enter Discount in %" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                       <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea name ="description" rows="5" col="10" id="description" class="form-control col-md-7 col-xs-12"> <%=description%>
                         </textarea>
                      </div>
