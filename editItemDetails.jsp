...
String status=request.getParameter("status");
                  ...
                  <form action ="../EditItem" method="post" name="my_form" class="form-horizontal form-label-left" onSubmit="document.my_form.editor_contents.value = $('#editor').html()" enctype="Multipart/form-data">
