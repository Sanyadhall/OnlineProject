                                        ...
                                        %>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                while (rs2.next()) {
                                                    ...
                                                    <li><a href="Product.jsp?sId=<%=rs2.getString("subCategoryId")%>"><%=rs2.getString("subCategoryName")%></a></li>
<%
    }
%>
                                                </ul>
						...
						<li><a href="mail.jsp">Mail Us</a></li>
                                                <li> <a href="Login.jsp" data-target="#myModal88" class="tooltips" title="Login"><span aria-hidden="true">Sign In</span></a></li>
					</ul>
				</div>
			</nav>
		</div>
