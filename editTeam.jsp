                  ...
                  <form action ="../EditTeam" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="Multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" pattern="([A-Za-z .])+" name="title" title="Enter Words Only" required="required" placeholder="Enter Title here"value="<%=name%>" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="email" pattern="[a-z][a-zA-Z.0-9@_#^*]+@[a-z]+\.[a-z]{2,3}" value="<%=email%>" name="email" title="Enter Words Only" readOnly="true" placeholder="Enter Email here" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="des" pattern="([A-Za-z .])+" name="des" value="<%=designation%>" title="Enter Words Only" required="required" placeholder="Enter Title here" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
