...
<div class="col-sm-3"></div>
                    <div class="register col-sm-6">
                        <h1 align="center"> <strong>Address Details</strong></h1>
                        <hr/>
                          <%
          ...
          if(rs.next());
          {
            %>
                        <form action="../AddressCheckOut" method="post">
                            ...
                            <input name="Mobile" placeholder="Mobile Phone" maxlength="10" pattern="[6-9][0-9]{9}" type="text" required="">
                             <input name="Address" placeholder="Address" type="text" required="">
                              <input name="Country" placeholder="Country" type="text" required="">
                                ...
                                <input name="Pin" placeholder="Pin" type="text" readOnly="true" value="<%=rs.getString("pin")%>">
                            <div class="sign-up">
