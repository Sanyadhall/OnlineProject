					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>Gallery <small><a href="subAdd_Gallery.jsp"><button class="btn-lg btn btn-outline btn-success">Add Gallery</button></a></small></h3>
								</div>
								<div class="col-md-6">
                        ...
                        <div class="image view view-first">
                          ...
                          <div class="mask">
                            ...
                            <div class="tools tools-bottom">
                                <a href="subedit_Gallery.jsp?gId=<%=rs.getString("galleryId")%>&image=<%=rs.getString("galleryName")%>&status=<%=rs.getString("galleryStatus")%>" data-toggle="tooltip" title="Edit Gallery"><i class="fa fa-pencil"></i></a>
