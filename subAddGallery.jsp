		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
                                                                    <h3>Gallery <small><a href="subview_Gallery.jsp"><button class="btn-lg btn btn-outline btn-success">View Gallery</button></a></small></h3>
								</div>
								<div class="col-md-6">
             ...
             <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form action ="../AddGallery1" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="Multipart/form-data">
